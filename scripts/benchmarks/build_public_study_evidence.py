...
def sanitized_audit_summary(
    ...
    *,
    ...
    return {
        ...
        "min_task_families": result.get("min_task_families", min_task_families),
        "min_tasks_per_family": result.get("min_tasks_per_family", min_tasks_per_family),
...
def build_public_bundle(
    *,
    ...
    public_manifest = {
        ...
        "minimum_task_families": manifest.get("minimum_task_families", 0),
        "minimum_tasks_per_family": manifest.get("minimum_tasks_per_family", 0),
