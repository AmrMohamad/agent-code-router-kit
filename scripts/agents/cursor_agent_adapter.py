...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Cursor Agent adapter launch-plan helper.")
    parser.add_argument("--config", default="benchmarks/real-agent-routing/agents/cursor-agent.yaml")
